...
| `uml:Package PKG_01` | → `package.id="PKG_01"`, `name="biblioteca"` |
| `uml:Class CLS_01` con `isAbstract="false"` | → `class.id="CLS_01"`, `name="Libro"`, `packageId="PKG_01"`, `isAbstract=false` |
